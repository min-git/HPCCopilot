  ...
  return (
    <div className="grid grid-cols-5 w-full items-center container mx-auto max-w-3xl justify-center h-full gap-9">
      <div className="col-span-2 gap-5 flex flex-col flex-1">
        ...
        <p className="">
          Welcome to Azure HPC Copilot! This is a interactive service that helps you choose right HPC service in Azure.           
          Start by just typing your HPC use case in the box below. You can also
